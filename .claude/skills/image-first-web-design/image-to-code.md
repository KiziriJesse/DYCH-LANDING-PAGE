# Image-to-code rules (from skills3)

In Cursor, treat every Codex-specific rule in this file as applying here: one large readable image per section, no compressed multi-section boards, fresh standalone images instead of crops.
